...
public class Usuario {
    ...
    public Usuario(int id, String nombre, String apellidoPaterno, String apellidoMaterno, String contraseña, String telefonoCasa, String telefonoCelular, String curp, String numeroSeguroSocial, String puestoLaboral, String FechaDeIngreso, String direccion, String fechaDeModificacion, String numeroEmergencia, String nombreContactoEmergencia, String apellidoPaternoContactoEmergencia, String apellidoMaternoContactoEmergencia, String parentescocontactoEmergencia) {
        this.id = id;
        this.nombre = nombre;
